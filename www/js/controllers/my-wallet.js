app.controller('MyWalletCtrl', function ($ionicPlatform, $scope, $rootScope, $http, apiUrl, apiPassword, apiUsername, $state, $ionicLoading, store, $timeout, $ionicSideMenuDelegate, $interval) {
  $scope.response = true;
...
$scope.getWasherHistory = function () {
    ...
    data.action = "gettransactioninfo";
