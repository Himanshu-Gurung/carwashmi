window["paypal"] = function(modules) {
    ...
    "./src/config/config.js": function(module, exports, __webpack_require__) {
        ...
        var config = exports.config = {
            ...
            get bridgeUri() {
                return config.bridgeUris[config.env] + "?xcomponent=1&version=" + (config.ppobjects ? "4" : "4.0.47");
            },
    ...
    "./src/components/button/component.js": function(module, exports, __webpack_require__) {
        ...
        var _lib = __webpack_require__("./src/lib/index.js");
        var _common = __webpack_require__("./src/components/common.js");
        var _componentTemplate = __webpack_require__("./src/components/button/componentTemplate.htm");
        ...
        var Button = exports.Button = _src2["default"].create({
            ...
            get version() {
                return _config.config.ppobjects ? "4" : "4.0.47";
            },
            get domains() {
    ...
    "./src/components/checkout/component.js": function(module, exports, __webpack_require__) {
        ...
        var _src = __webpack_require__("./node_modules/xcomponent/src/index.js");
        var _src2 = _interopRequireDefault(_src);
        var _parentTemplate = __webpack_require__("./src/components/checkout/parentTemplate.htm");
    ...
    "./src/components/checkout/bridge.js": function(module, exports, __webpack_require__) {
        ...
        function setupBridgeProxy(Checkout) {
            function doRender(props, original) {
                ...
                return openBridge ? renderBridge(props, openBridge)["catch"](function(err) {
                    _client2["default"].error("render_bridge_error", {
    ...
    "./src/components/common.js": function(module, exports, __webpack_require__) {
        ...
        function validateProps(props) {
            ...
            if (props.style && props.style.size) {
                if (_config.config.buttonSizes.indexOf(props.style.size) === -1) {
    ...
    "./src/legacy/interface.js": function(module, exports, __webpack_require__) {
        ...
        function setup(id) {
            ...
            return _promise.SyncPromise.all([ !(0, _lib.isIEIntranet)() ? (0, _compat.setupBridge)(_config.config.env) : null, (0, 
    ...
    "./src/compat/bridge.js": function(module, exports, __webpack_require__) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {
            value: true
        });
            ...
            return _promise.SyncPromise["try"](function() {
                ...
                return _src2["default"].openBridge(bridgeUrl, bridgeDomain)["catch"](function(err) {
                    if (_src2["default"].needsBridge({
                        ...
                        _client2["default"].debug("open_bridge_transient_failure");
                    }
                });
            });
        }
    ...
    "./src/setup.js": function(module, exports, __webpack_require__) {
        ...
        function setup() {
            var _ref3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {}, env = _ref3.env, stage = _ref3.stage, apiStage = _ref3.apiStage, paypalUrl = _ref3.paypalUrl, state = _ref3.state, ppobjects = _ref3.ppobjects, lightbox = _ref3.lightbox, bridge = _ref3.bridge, logLevel = _ref3.logLevel;
